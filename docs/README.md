...
FinWiz features comprehensive documentation organized using the Diátaxis framework and published on GitHub Pages:
...
- **Full-Text Search**: Integrated GitHub search
...
**Deployment**: Documentation is automatically deployed to GitHub Pages when changes are pushed to the `main` branch. Configure in GitHub Settings → Pages → Source: Deploy from branch `main` → `/docs`
