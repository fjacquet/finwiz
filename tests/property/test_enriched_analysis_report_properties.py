...
class TestEnrichedAnalysisReportProperties:
    ...
    # Additional property: Quality validation catches invalid data
    @given(
    ...
    def test_quality_validation_rejects_insufficient_data(self, word_count, insights_count):
        ...
        report generation should raise ValueError.
        """
        # Arrange
        generator = EnrichedAnalysisReportGenerator()

        # Create data that violates quality thresholds
        invalid_data = {
            "ticker": "TEST",
        ...
        assert "Quality validation failed" in error_msg or "Word count" in error_msg or "Insights count" in error_msg
