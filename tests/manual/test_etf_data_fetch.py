...
def test_etf_data(ticker: str = "SPY"):
    ...
    try:
        ...
        if expense_ratio is not None:
            ...
            print("❌ Expense Ratio: NOT AVAILABLE")
        ...
        if total_assets is not None:
            ...
            print("❌ Total Assets (AUM): NOT AVAILABLE")
        ...
        if not hist.empty:
            ...
            print("  Note: Tracking error requires benchmark data")
        else:
        ...
        if has_expense_ratio and has_aum:
            ...
            if not has_expense_ratio:
                print("   ❌ Expense Ratio missing")
            if not has_aum:
                print("   ❌ AUM missing")

        print("⚠️ Tracking error calculation not yet implemented")
