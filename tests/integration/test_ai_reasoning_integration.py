...
class TestAIReasoningIntegration:
    ...
    def test_stock_crew_ai_reasoning_in_output(self):
    ...
    def test_ai_reasoning_configuration_consistency(self):
    ...
    def test_ai_agents_have_reasoning_enabled(self):
    ...
    def test_ai_reasoning_task_configuration(self):
    ...
    def test_ai_reasoning_output_structure(self):
