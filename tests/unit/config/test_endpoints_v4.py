"""Unit tests for v4 endpoint constants (Finnhub, FRED, Fear & Greed, gnews)."""
...
class TestV4Endpoints:
    ...
    def test_gnews_base_default(self):
        assert endpoints.GNEWS_BASE == "https://gnews.io/api/v4"

    def test_fred_base_default(self):
        assert endpoints.FRED_BASE == "https://api.stlouisfed.org/fred"
