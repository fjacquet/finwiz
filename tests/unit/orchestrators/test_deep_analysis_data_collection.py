...
class TestPythonDataCollection:
    ...
    def mock_sec_data(self):
        ...
        return json.dumps({
            ...
            "risk_factors": {
                "total_risks": 15,
                "high_priority": 3,
                "categories": ["Competition", "Supply Chain", "Regulatory"]
            },
    ...
    def test_collect_data_with_python_success(self, mocker, orchestrator, mock_yahoo_ticker_data,
                                              mock_yahoo_company_data, mock_quantitative_data,
                                              mock_sentiment_data, mock_sec_data):
