...
class TestCoreAnalysisFeatureFlags:
    ...
    def test_should_execute_stock_crew_when_flag_enabled(self, finwiz_flow, mocker):
    ...
    def test_should_handle_mixed_feature_flag_states(self, finwiz_flow, mocker):
        ...
        mock_feature_enabled = mocker.patch("finwiz.main.is_feature_enabled", side_effect=mock_feature_enabled_side_effect)
        mock_stock_crew_class = mocker.patch("finwiz.main.StockCrew")
        mock_etf_crew_class = mocker.patch("finwiz.main.EtfCrew")
        mock_crypto_crew_class = mocker.patch("finwiz.main.CryptoCrew")
    ...
    def test_should_handle_all_crews_enabled(self, finwiz_flow, mocker):
    ...
    def test_should_respect_feature_flags_during_errors(self, finwiz_flow, mocker):
        """Test that feature flags are respected even when crews fail."""
        # Test with feature flag enabled but crew fails
        mock_feature_enabled = mocker.patch("finwiz.main.is_feature_enabled")
        mock_feature_enabled.return_value = True
        ...
        mock_stock_crew_class.reset_mock()
    ...
    def test_should_handle_dynamic_feature_flag_changes(self, finwiz_flow, mocker):
        ...
        mock_feature_enabled = mocker.patch("finwiz.main.is_feature_enabled", side_effect=dynamic_feature_enabled)
        mock_stock_crew_class = mocker.patch("finwiz.main.StockCrew")
        mock_stock_crew = mocker.MagicMock()
        mock_result = mocker.MagicMock()
        mock_result.raw = "Stock analysis executed"
    ...
    def test_should_handle_feature_flag_environment_variables(self, finwiz_flow, mocker):
        ...
        mock_feature_enabled = mocker.patch("finwiz.main.is_feature_enabled", side_effect=env_feature_enabled)
        mock_stock_crew_class = mocker.patch("finwiz.main.StockCrew")
        mock_crypto_crew_class = mocker.patch("finwiz.main.CryptoCrew")
