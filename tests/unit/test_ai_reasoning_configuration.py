...
class TestAIReasoningConfiguration:
    ...
    def test_stock_crew_agents_have_reasoning_enabled(self, mocker):
    ...
    def test_etf_crew_agents_have_reasoning_enabled(self, mocker):
    ...
    def test_crypto_crew_agents_have_reasoning_enabled(self, mocker):
    ...
    def test_crews_have_llm_configuration_method(self, mocker):
    ...
    def test_llm_configuration_parameters(self, mocker):
    ...
    def test_agents_use_configured_llm(self, mocker):
    ...
    def test_ai_driven_decision_making_configuration(self, mocker):
