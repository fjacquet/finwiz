...
def update_market_data(tickers: List[str], collection_suffix: Optional[str] = None) -> None:
    """
...
def prune_outdated_knowledge(max_age_days: int = 30, 
                            collection_suffix: Optional[str] = None) -> None:
    """
